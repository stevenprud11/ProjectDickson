...
class SearchBarCat extends Component{
    ...
    fetchAPI() {
        fetch('http://localhost/bars/searchCategory?bar_name='+this.props.state.bar_name+'&drink_category='+this.props.state.category)
    ...
    render(){
        ...
        else if(this.props.state.bar_name !== '' && this.props.state.category !== ''){
            return(
            <div>
